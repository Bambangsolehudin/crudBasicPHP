...
<head>
 ...
 <!-- container -->
	...
	<!-- <div class="row">
      ...
      <div class="col s12 m8 l7 card" style=" font-size: 10pt;"> <!-- Note that "m8 l9" was added -->
			...
			<form action="" method="post">
				<p style="font-size: 15pt;">Daftar Obat</p>
	...
	<!-- tabel Pasien -->
			<form action="" method="post">
				<button type="submit" class="#00acc1 cyan darken-1"><a href="tambah2.php" style="color: white;">Tambah Data</a></button>
			</form>
			<table border="1" cellpadding="10" class="striped" class="">
					...
					<tr>
						...
						<td>
							<a class="btn-small" href="ubah2.php?id=<?=$row["id"]; ?>" >ubah </a>
							<a class="btn-small" href="hapus2.php?id=<?=$row["id"]; ?>" >hapus</a>
						</td>
					</tr>
					<?php $i++; ?>
				<?php endforeach; ?>	
