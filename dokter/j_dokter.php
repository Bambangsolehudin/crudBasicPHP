...
// pagnition
//configuration 
$pasien=query("SELECT * FROM j_dokter");
...
<head>
 ...
 <!-- container -->
	...
	<!-- <div class="row">
		    ...
		    <li>
		        ...
		        <img src="../img/c.jpg " class="responsive-img" >
				    ...
				    <li><a href="../pasien/index2.php">Daftar Pasien</a></li>
				     <li><a href="j_dokter.php">Daftar Jadwal Dokter</a></li>
      ...
      <div class="col s12 m8 l7 card" style=" font-size: 10pt;"> <!-- Note that "m8 l9" was added -->
			...
			<form action="" method="post">
				<p style="font-size: 15pt;">Daftar Jadwal Dokter</p>
	...
	<!-- tabel Pasien -->
			<form action="" method="post">
				<button type="submit" class="#00acc1 cyan darken-1"><a href="tambah1.php" style="color: white;">Tambah Data</a></button>
			</form>
			<table border="1" cellpadding="10" class="striped" class="">
					...
					<tr>
						...
						<td><?=$row["almt_dokter"]; ?></td>
						<td><?=$row["jdwl_dokter"]; ?></td>
						
						<td>
							<a class="btn-small" href="ubah1.php?id=<?=$row["id"]; ?>" >ubah </a>
							<a class="btn-small" href="hapus1.php?id=<?=$row["id"]; ?>" >hapus</a>
						</td>
					</tr>
					<?php $i++; ?>
				<?php endforeach; ?>	
